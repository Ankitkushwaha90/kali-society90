"use client"
import { getDsafile } from "@/sanity/sanity-utils";
...
async function Webdesignss({ params }: Props){
  const Webdesigns = await getDsafile(params.slug);
  ...
  return (
    ...
    <div>
      ...
      <div className="text-lg text-gray-700 mt-10">
          ...
          <h1>{Webdesigns.title}</h1>

          <Webdesignss params={params}/>
        
      </div>
    </div>
    <PortableText value={Webdesigns.content} />
   
    <PortableText value={Webdesigns.body} />
